...
class MenuPersetujuanPengisianKrs(Action):
    def name(self) -> Text:
        return "action_menu_persetujuanPengisianKrs"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_persetujuanPengisianKrs_ok")
        pilihan_menu = tracker.get_slot("menu_persetujuanPengisianKrs")
        dispatcher.utter_message(json_message={"context": "persetujuanPengisianKrs"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Persetujuan Pengisian KRS":
                return [SlotSet("return_value", "Hasil Persetujuan Pengisian KRS")]
            case _:
                return []
