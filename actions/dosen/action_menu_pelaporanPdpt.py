...
class MenuPelaporanPdpt(Action):
    def name(self) -> Text:
        return "action_menu_pelaporanPdpt"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_pelaporanPdpt_ok")
        pilihan_menu = tracker.get_slot("menu_pelaporanPdpt")
        dispatcher.utter_message(json_message={"context": "pelaporanPdpt"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Pelaporan PDPT":
                return [SlotSet("return_value", "Hasil Pelaporan PDPT")]
            case _:
                return []
