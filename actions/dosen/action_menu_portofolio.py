...
class MenuPortofolio(Action):
    def name(self) -> Text:
        return "action_menu_portofolio"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_portofolio_ok")
        pilihan_menu = tracker.get_slot("menu_portofolio")
        dispatcher.utter_message(json_message={"context": "portofolio"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Portofolio":
                return [SlotSet("return_value", "Hasil Portofolio")]
            case _:
                return []
