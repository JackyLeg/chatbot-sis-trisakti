...
class MenuDaftarMahasiswaPerKelas(Action):
    def name(self) -> Text:
        return "action_menu_daftarMahasiswaPerKelas"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_daftarMahasiswaPerKelas_ok")
        pilihan_menu = tracker.get_slot("menu_daftarMahasiswaPerKelas")
        dispatcher.utter_message(json_message={"context": "daftarMahasiswaPerKelas"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Daftar Mahasiswa per Kelas":
                return [SlotSet("return_value", "Hasil Daftar Mahasiswa per Kelas")]
            case _:
                return []
