...
class MenuRps(Action):
    def name(self) -> Text:
        return "action_menu_rps"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_rps_ok")
        pilihan_menu = tracker.get_slot("menu_rps")
        dispatcher.utter_message(json_message={"context": "rps"})
        ...
        match pilihan_menu:
            ...
            case "Hasil RPS":
                return [SlotSet("return_value", "Hasil RPS")]
            case _:
                return []
