...
class MenuBimbinganKerjaPraktek(Action):
    def name(self) -> Text:
        return "action_menu_bimbinganKerjaPraktek"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_bimbinganKerjaPraktek_ok")
        pilihan_menu = tracker.get_slot("menu_bimbinganKerjaPraktek")
        dispatcher.utter_message(json_message={"context": "bimbinganKerjaPraktek"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Bimbingan Kerja Praktek":
                return [SlotSet("return_value", "Hasil Bimbingan Kerja Praktek")]
            case _:
                return []
