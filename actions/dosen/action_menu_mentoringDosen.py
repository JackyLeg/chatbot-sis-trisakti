...
class MenuMentoringDosen(Action):
    def name(self) -> Text:
        return "action_menu_mentoringDosen"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_mentoringDosen_ok")
        pilihan_menu = tracker.get_slot("menu_mentoringDosen")
        dispatcher.utter_message(json_message={"context": "mentoringDosen"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Mentoring Dosen":
                return [SlotSet("return_value", "Hasil Mentoring Dosen")]
            case _:
                return []
