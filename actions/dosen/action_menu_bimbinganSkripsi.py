...
class MenuBimbinganSkripsi(Action):
    def name(self) -> Text:
        return "action_menu_bimbinganSkripsi"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_bimbinganSkripsi_ok")
        pilihan_menu = tracker.get_slot("menu_bimbinganSkripsi")
        dispatcher.utter_message(json_message={"context": "bimbinganSkripsi"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Bimbingan Skripsi":
                return [SlotSet("return_value", "Hasil Bimbingan Skripsi")]
            case _:
                return []
