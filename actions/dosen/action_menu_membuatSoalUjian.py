...
class MenuMembuatSoalUjian(Action):
    def name(self) -> Text:
        return "action_menu_membuatSoalUjian"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_membuatSoalUjian_ok")
        pilihan_menu = tracker.get_slot("menu_membuatSoalUjian")
        dispatcher.utter_message(json_message={"context": "membuatSoalUjian"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Membuat Soal Ujian":
                return [SlotSet("return_value", "Hasil Membuat Soal Ujian")]
            case _:
                return []
