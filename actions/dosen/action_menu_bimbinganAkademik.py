...
class MenuBimbinganAkademik(Action):
    def name(self) -> Text:
        return "action_menu_bimbinganAkademik"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_bimbinganAkademik_ok")
        pilihan_menu = tracker.get_slot("menu_bimbinganAkademik")
        dispatcher.utter_message(json_message={"context": "bimbinganAkademik"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Bimbingan Akademik":
                return [SlotSet("return_value", "Hasil Bimbingan Akademik")]
            case _:
                return []
