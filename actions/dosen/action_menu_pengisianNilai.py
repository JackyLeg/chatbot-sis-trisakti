...
class MenuPengisianNilai(Action):
    def name(self) -> Text:
        return "action_menu_pengisianNilai"
    ...
    def run(
        ...
        dispatcher.utter_message(response = "utter_menu_pengisianNilai_ok")
        pilihan_menu = tracker.get_slot("menu_pengisianNilai")
        dispatcher.utter_message(json_message={"context": "pengisianNilai"})
        ...
        match pilihan_menu:
            ...
            case "Hasil Pengisian Nilai":
                return [SlotSet("return_value", "Hasil Pengisian Nilai")]
            case _:
                return []
